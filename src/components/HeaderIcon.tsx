...
const HeaderIcon: React.FC = (): JSX.Element => {
    return (
        <div className='flex'>
            <div className="top-20 left-0 z-50 w-full h-16 bg-white border-t border-b my-2 border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                <div className="grid h-full max-w-lg grid-cols-4 font-medium">
                    <img src={logo} className="App-logo-icon ml-10 cursor-pointer " alt="logo" />    
